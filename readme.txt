...
Tags: gutenberg, blocks, rpg, role-playing game, dice, character generator
...
Extends the RAVE Dice Roller block to create a simple character generator.
...
1. Admin Demo: Insert Character Generator block.
